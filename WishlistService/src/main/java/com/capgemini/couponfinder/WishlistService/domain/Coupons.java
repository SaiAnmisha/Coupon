...
public class Coupons {
    ...
    public Coupons(String couponId, String couponName,String couponImage, String couponDescription, String couponCode,String couponCategory,String couponStore,String couponRate) {
        super();
